...
def generate_report():
    ...
    outputFile = open("Results/Final_Report_remote_20_to_2_label0.txt", 'a+')
    for results in all_results_list:
        ...
        for freqItem in results[1]:
            ...
            transactions_file = open("bio_data/United_transactions.csv", 'r')
...
def generate_running_time_graph():
    ...
    plt.savefig('Results/Running_time_graph_30_to_2_remote.png')
    plt.show()
...
if __name__ == "__main__":
    ...
    running_times = []
    minSup_list = []
    for j in range(20, 1, -2):  # backward loop from 50 to 2
